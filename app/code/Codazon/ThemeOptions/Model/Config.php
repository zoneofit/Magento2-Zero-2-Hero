...
class Config extends \Magento\Framework\DataObject
{
    ...
    public function __construct(
        ...
        \Codazon\ThemeOptions\Model\Config\Loader $configLoader,
        \Codazon\ThemeOptions\Framework\App\Config\ValueFactory $configValueFactory,
        ...
        //$tmp = $objectManager->get('Magento\Config\Model\ResourceModel\Config\Data');
        //unset($tmp);
    }
        ...
        if (isset($groupData['fields'])) {
            ...
            foreach ($groupData['fields'] as $fieldId => $fieldData) {
                ...
                $backendModel = $field->hasBackendModel() ? $field
                    ...
                    ->create();
                /*$backendModel = $field->hasBackendModel() ? $field
                    ->getBackendModel() : $this->_objectManager->create('Codazon\ThemeOptions\Model\ResourceModel\Config\Data');*/
    ...
    public function load()
    {
        if ($this->_configData === null) {
            $this->initScope();
            $this->_configData = $this->_getConfigForLoadForm(false);
        }
    ...
    protected function _getConfigForLoadForm($full = true)
    {
        return $this->_configLoader->getConfigByPathForLoadForm(
            $this->getSection(),
            $this->getScope(),
            $this->getScopeId(),
            $this->getTheme(),
