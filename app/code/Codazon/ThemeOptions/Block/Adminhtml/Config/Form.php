 ...
 */
namespace Codazon\ThemeOptions\Block\Adminhtml\Config;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    public function __construct(
        ...
        \Codazon\ThemeOptions\Helper\Data $settingHelper,
        array $data = []
    ) {
    ...
    protected function _initElement(
        ...
        /*if($data == null)
            $data = $this->_settingHelper->getConfig($path);*/
    ...
    {
    	//echo $this->getScopeCode();die;
    	$configDataCollection = $this->_objectManager->create('Codazon\ThemeOptions\Model\ResourceModel\Config\Data\Collection');
        $configDataCollection->addScopeFilter($this->getScope(), $this->getScopeId(), $this->getThemeId(), $path);
        $config = $configDataCollection->getFirstItem();
