    ...
    $.widget('custom.SwatchRenderer', {
        ...
        _create: function () {
            var options = this.options,
                gallery = $('[data-gallery-role=gallery-placeholder]', '.qs-main'),
        ...
        _LoadProductMedia: function () {
            ...
            if ($('body.cdz-qs-view').size() > 0) {
                //Product Page
                productId = $('#quickshop-info-main #product_addtocart_form [name="product"]').val(); //document.getElementsByName('product')[0].value;
            } else {
                //Category View
        ...
        _EnableProductMediaLoader: function ($this) {
            ...
            if ($('body.cdz-qs-view').size() > 0) {
                $this.parents('.qs-main').find('.photo.image')
        ...
        _ProductMediaCallback: function ($this, response) {
            var isProductViewExist = $('body.cdz-qs-view').size() > 0,
                $main = isProductViewExist
                    ? $this.parents('.qs-main')
